...
public class TetrisSong implements Runnable {
    private static final String SWORDARTONLINE ="sword.mid";
    private static final String GAMEOVER ="FT.mid";
    private Sequencer sequencer;

    @Override
    public void run() {
        InputStream song = TetrisSong.class.getClassLoader().getResourceAsStream(SWORDARTONLINE);
        this.doPlayMidi(song, true);
    }

    public void runEndSong(){
        InputStream song = TetrisSong.class.getClassLoader().getResourceAsStream(GAMEOVER);
        this.doPlayMidi(song, true);
    }
